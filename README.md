...
### Modes
The program features one and two player modes. If two player is selected, user(s) can take turns making moves on the same device. If one player mode is selected, the user will have the opportunity to choose which color they want to play with, and get to play against the wellknown stockfish chess engine. **Keep in mind the engine makes the best possible move so don't feel bad when you lose!** The engine will automatically make a move after the user makes a move.
